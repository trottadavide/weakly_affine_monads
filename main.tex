...
\todo{Mi sembra che se nel caso $T$ sia weakly affine allora $T(1)\cong !$ nella Kleisli $A_T$}
\begin{mylemma}
	\label{lem:T1_group}
...
\end{proof}
\todo{Mi sembra che se nel caso $T$ sia weakly affine allora $T(1)\cong !$ nella Kleisli $A_T$. Bisogna vedere se è vero che $T(\eta_1)\iota=\eta_{T(1)}$ }
\begin{mycorollary}
