...
\begin{myproposition}
 Let $\mC$ be a weakly Markov CD-category. Let $f:A\to X\otimes Y\otimes Z$ be a morphism exhibiting conditional independence of $X\otimes Y$ (jointly) and $Z$ given $A$, as well as conditional independence of $X$ and $Y\otimes Z$ given $A$. 
